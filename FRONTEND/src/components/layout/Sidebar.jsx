...
export default function Sidebar() {
  const menuItems = [
    ...
    { icon: Activity, label: 'Maladies', active: false },
    { icon: Bell, label: 'Alertes IA', active: false },
    { icon: FileText, label: 'Rapports', active: false },
  ];

  return (
    <div className="w-64 bg-gradient-to-b from-primary to-blue-800 text-white min-h-screen fixed top-0 left-0 p-4 flex flex-col">
      {/* Logo */}
      <div className="mb-10 mt-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-300 uppercase tracking-wider">Surveillance Épidémiologique</p>
          </div>
        </div>
      </div>
